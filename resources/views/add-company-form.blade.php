<x-app-layout>
    ...
    <div class="mx-w-7xl sm:px-6 lg:px-8 py-4">
        <div class="bg-gray-700 rounded-xl p-5">
            <form method="POST" action="{{ route('company.store') }}" class="w-full" enctype="multipart/form-data">
                @csrf
                <div class="w-full flex flex-wrap gap-[1%]">
                    <div class="mb-3 w-[49%]">
                        <input
                            class="bg-grey-700 border-1 rounded-xl w-full py-2 px-3 bg-gray-700 focus:outline-gray-300 outline-none text-white"
                            placeholder="Company Name" type="text" name="name">
                        @error('name')
                    ...
                    <div class="mb-3 w-[49%]">
                        <input
                            class="bg-grey-700 border-1 rounded-xl w-full py-2 px-3 bg-gray-700 focus:outline-gray-300 outline-none text-white"
                            placeholder="Company Email" type="email" name="email">
                        @error('email')
                            <small class="text-red-200">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="mb-3 w-[49%]">
                        <input
                            class="bg-grey-700 border-1 rounded-xl w-full py-2 px-3 bg-gray-700 focus:outline-gray-300 outline-none text-white"
                            placeholder="Company Website" type="text" name="website">
                        @error('website')
                            <small class="text-red-200">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="mb-3 w-[49%]">
                        <input
                            class="bg-grey-700 border-1 rounded-xl w-full py-2 px-3 bg-gray-700 focus:outline-gray-300 outline-none text-white"
                            placeholder="Company Address" type="text" name="address">
                        @error('address')
                            <small class="text-red-200">{{ $message }}</small>
                        @enderror
                    </div>
